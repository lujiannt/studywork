...
<html>
	...
	<body>
		...
		<h1>添加院系</h1>
			...
			<input type="hidden" name="method" value="addDepart"/>
				<ol>
					<li>
						...
						<input id="Email" name="dno" type="text" style="color:#999999;font-family: 'Open Sans', sans-serif;" value=""/>
					</li>
					<li>
						...
						<input id="UserName" name="dname" type="text" style="color:#999999;font-family: 'Open Sans', sans-serif;" value=""/>
					</li>
					<li>
						...
						<input id="Password" name="dphone" type="text" style="color:#999999;font-family: 'Open Sans', sans-serif;"/>
					</li>
					<li>
						...
						<span class="field-validation-valid" data-valmsg-for="Password" data-valmsg-replace="true"></span>
						<input id="Password" name="dleader" type="text" style="color:#999999;font-family: 'Open Sans', sans-serif;"/>
					</li>
					<li>
				...
				<input type="submit" value="添加" class="btn-submit"/>
		    <span><%="    " %>              ${msg}</span>
			</form>
		</div>
	</body>
