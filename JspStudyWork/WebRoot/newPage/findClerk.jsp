...
<script type="text/javascript">
	function findClerkByCondition() {
	   ...
	   var url = "<%=basePath%>clerk/findClerk.jsp?method=findClerkByCondition&condition="+condition;
	   window.location =url;
	   }else {
	   alert("请输入查询条件!");
	   }
  ...
  %>
	...
	<table  class="table" border='1' bordercolor="#CAE1FF" cellspacing="0" cellpadding="0">
		...
		<c:forEach items="${list}" var="clerk">
			<tr>
				<td class='onecenter'
					style="color:#999999;font-family: 'Open Sans', sans-serif;">${clerk.id}</td>
				<td class='onecenter'
					style="color:#999999;font-family: 'Open Sans', sans-serif;">${clerk.uid}</td>
				<td class='onecenter'
					style="color:#999999;font-family: 'Open Sans', sans-serif;">${clerk.uname}</td>
				<td class='onecenter'
					style="color:#999999;font-family: 'Open Sans', sans-serif;">${clerk.sex}</td>
				<td class='onecenter'
					style="color:#999999;font-family: 'Open Sans', sans-serif;">${clerk.phone}</td>
				<td class='onecenter'
					style="color:#999999;font-family: 'Open Sans', sans-serif;">${clerk.email}</td>
				<td class='onecenter'
					style="color:#999999;font-family: 'Open Sans', sans-serif;">${clerk.dname}</td>
				<td class='onecenter'
					style="color:#999999;font-family: 'Open Sans', sans-serif;">${clerk.cname}</td>
				<td class='onecenter'
					style="color:#999999;font-family: 'Open Sans', sans-serif;">${clerk.upost}</td>
				<td class='onecenter'
					style="color:#999999;font-family: 'Open Sans', sans-serif;">${clerk.worktime}</td>
				<td class='onecenter'
					style="color:#999999;font-family: 'Open Sans', sans-serif;">${clerk.kname}</td>
				<td class='onecenter'
					style="color:#999999;font-family: 'Open Sans', sans-serif;">${clerk.account}</td>
			</tr>
		</c:forEach>
		<!-- 没有找到的情况下 -->
		<%
		...
		<tr>
		  <td  align="center" colspan="11" class='onecenter'
	...
	%>
 &nbsp;&nbsp;&nbsp; &nbsp;  &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 <span style="color:#999999;font-family: 'Open Sans', sans-serif;">当前第<%=p.getPageIndex()%>页
    
 <a href="<%=basePath %>clerk/findClerk.jsp?pageIndex=1" style="color:#999999;font-family: 'Open Sans', sans-serif;">首页</a>
   
 <%if(p.getPageIndex()>1) {%>
 
 <a href="<%=basePath %>clerk/findClerk.jsp?pageIndex=<%=pageIndex-1 %>" style="color:#999999;font-family: 'Open Sans', sans-serif;">上一页</a>
 
 <%}  if(p.getPageIndex()<p.getCount()) {%>
 
 <a href="<%=basePath %>clerk/findClerk.jsp?pageIndex=<%=pageIndex+1 %>" style="color:#999999;font-family: 'Open Sans', sans-serif;">下一页</a>
 
 <% }%>
  
 <a href="<%=basePath %>clerk/findClerk.jsp?pageIndex=<%=p.getCount() %>" style="color:#999999;font-family: 'Open Sans', sans-serif;">末页</a> 
   共<%=p.getCount() %>页</span>
   <%} %>	
  <!-- 分页 --> 
